...
// IDX Sectors (Updated: 963 stocks in 11 sectors — as of 10 Jul 2026)
const IDX_SECTORS = {
  ...
  'Financials': ['ABDA', 'ADMF', 'AGRO', 'AGRS', 'AHAP', 'AMAG', 'APIC', 'ARTO', 'ASBI', 'ASDM', 'ASJT', 'ASMI', 'ASRM', 'BABP', 'BACA', 'BBCA', 'BBHI', 'BBKP', 'BBLD', 'BBMD', 'BBNI', 'BBRI', 'BBTN', 'BBYB', 'BCAP', 'BCIC', 'BDMN', 'BEKS', 'BFIN', 'BGTG', 'BINA', 'BJBR', 'BJTM', 'BKSW', 'BMAS', 'BMRI', 'BNBA', 'BNGA', 'BNII', 'BNLI', 'BPFI', 'BPII', 'BSIM', 'BSWD', 'BTPN', 'BVIC', 'CFIN', 'DEFI', 'DNAR', 'DNET', 'GSMF', 'HDFA', 'INPC', 'LPGI', 'LPPS', 'MAYA', 'MCOR', 'MEGA', 'MREI', 'NISP', 'NOBU', 'OCAP', 'PADI', 'PALM', 'PANS', 'PEGE', 'PLAS', 'PNBN', 'PNBS', 'PNIN', 'PNLF', 'POOL', 'RELI', 'SDRA', 'SMMA', 'SRTG', 'STAR', 'TIFA', 'TRIM', 'TRUS', 'VICO', 'VINS', 'VRNA', 'WOMF', 'YULE', 'CASA', 'BRIS', 'MTWI', 'JMAS', 'NICK', 'BTPS', 'TUGU', 'POLA', 'SFAN', 'LIFE', 'FUJI', 'AMAR', 'AMOR', 'BHAT', 'BBSI', 'BANK', 'MASB', 'VTNY', 'YOII', 'COIN', 'SUPA'],
  'Healthcare': ['BMHS', 'CARE', 'CHEK', 'DGNS', 'DKHH', 'DVLA', 'EMMI', 'HALO', 'HEAL', 'IKPM', 'INAF', 'IRRA', 'JECX', 'KAEF', 'KLBF', 'LABS', 'MDLA', 'MEDS', 'MERK', 'MIKA', 'MMIX', 'MTMH', 'OBAT', 'OMED', 'PEHA', 'PEVE', 'PRAY', 'PRDA', 'PRDL', 'PRIM', 'PYFA', 'RSCH', 'RSGK', 'SAME', 'SCPI', 'SIDO', 'SILO', 'SOHO', 'SRAJ', 'SURI', 'TSPC'],
  'Industrials': ['AMFG', 'AMIN', 'APII', 'ARNA', 'ASGR', 'ASII', 'BACH', 'BHIT', 'BNBR', 'CTTH', 'DYAN', 'HEXA', 'IBFN', 'ICON', 'IKAI', 'IKBI', 'IMPC', 'INDX', 'INTA', 'JECC', 'JTPE', 'KBLI', 'KBLM', 'KIAS', 'KOBX', 'KOIN', 'KONI', 'LION', 'MDRN', 'MFMI', 'MLIA', 'SCCO', 'TIRA', 'TOTO', 'TRIL', 'UNTR', 'VOKS', 'ZBRA', 'MARK', 'SPTO', 'SKRN', 'CAKK', 'SOSS', 'CCSI', 'BLUE', 'ARKA', 'SINI', 'HOPE', 'LABA', 'GPSO', 'KUAS', 'BINO', 'NTBK', 'PADA', 'KING', 'PTMP', 'SMIL', 'CRSN', 'WIDI', 'FOLK', 'MUTU', 'HYGN', 'VISI', 'MHKI', 'NAIK', 'PIPA'],
  ...
  'Transportation & Logistic': ['AKSI', 'ASSA', 'BIRD', 'BLTA', 'CMPP', 'GIAA', 'IMJS', 'LRNA', 'MIRA', 'MITI', 'NELY', 'SAFE', 'SDMU', 'SMDR', 'TAXI', 'TMAS', 'WBSA', 'WEHA', 'HELI', 'TRUK', 'TNCA', 'BPTR', 'SAPX', 'DEAL', 'JAYA', 'KJEN', 'PURA', 'PPGL', 'TRJA', 'HAIS', 'HATM', 'RCCC', 'ELPI', 'LAJU', 'GTRA', 'MPXL', 'KLAS', 'LOPI', 'BLOG', 'PJHB'],
};
